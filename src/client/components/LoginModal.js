      ...
      >
        <div className="LoginModal__body">
          ...
          <span className="LoginModal__login-title">
            <FormattedMessage id="login_to_cocozl" defaultMessage="Login to cocozl" />
          </span>
          <span className="LoginModal__login-description">
            <FormattedMessage
              id="login_modal_description"
              defaultMessage="Login with your Steem account using SteemConnect to enjoy cocozl at 100%"
            />
          </span>
