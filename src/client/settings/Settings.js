  ...
  render() {
    ...
    return (
      <div className="shifted">
        <Helmet>
          <title>{intl.formatMessage({ id: 'settings', defaultMessage: 'Settings' })} - cocozl</title>
        </Helmet>
              ...
              <div className="Settings">
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      id="language_info"
                      defaultMessage="What language do you want to use on cocozl?"
                    />
                  </p>
                  <Select
                ...
                <div className="Settings__section">
                  ...
                  <p>
                    <FormattedMessage
                      ...
                      defaultMessage="You can enable this option to replace Steemit.com links with cocozl.com links."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
                    <Checkbox
                ...
                <div className="Settings__section">
                  <h3>
                    <FormattedMessage id="use_beta" defaultMessage="Use cocozl beta" />
                  </h3>
                  <p>
                    <FormattedMessage
                      id="use_beta_details"
                      defaultMessage="You can enable this option to use cocozl beta by default."
                    />
                  </p>
                  <div className="Settings__section__checkbox">
