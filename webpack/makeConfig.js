  ...
  let plugins = [
    new webpack.DefinePlugin({
      'process.env': {
        ...
        STEEMCONNECT_CLIENT_ID: JSON.stringify(process.env.STEEMCONNECT_CLIENT_ID || 'cocozl.app'),
        ...
        SIGNUP_URL: JSON.stringify(process.env.SIGNUP_URL || 'https://signup.steemit.com/?ref=cocozl'),
      },
    }),
...
function makeConfig(options = {}) {
  ...
  return {
    ...
    output: {
      ...
      filename: options.isDevelopment ? 'bundle.js' : 'cocozlapp-[name].[chunkhash].js',
      publicPath: '/js/',
    },
